		...
		<div><a href="<%=basePath%>SlistexampleServ1" >查看案例列表</a></div>
			<form action="<%=basePath%>SaddexampleServs" method="post" enctype="multipart/form-data" class="form-x">
				...
				<div class="form-group">
					...
					<div class="field" style="padding-top:8px;">
						<input name="sl" type="checkbox" value="经典"/>经典 
						<input name="sl" type="checkbox" value="喜庆"/>喜庆
						<input name="sl" type="checkbox" value="时髦"/>时髦
						<input name="sl" type="checkbox" value="丛林风"/>丛林风
						<input name="sl" type="checkbox" value="梦幻城堡"/>梦幻城堡
					</div></div>
					<div class="form-group">
						<div class="label">
							<label>婚礼日期：</label>
					...
					<div class="form-group">
						...
						<div class="field">
							<input type="file" name="image3"  style="float:left;">
							<div class="tipss">图片尺寸：500*500</div>
						</div>
					</div>
					<div class="form-group">

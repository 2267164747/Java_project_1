    ...
    <table class="table table-hover text-center">
      ...
      <volist name="list" id="vo">
        <tr>
          ...
          <td><input type="text" name="sort[1]" value="1" s /></td>
          <td></td>
          <td>我们的名字叫微距</td>
          <td><font color="#00CC99"></font></td>
          <td>旅游分类</td>
          <td><div class="button-group"> <a class="button border-main" href="add.html">
          <span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,1,1)">

...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/wandajiahua.css"/>
		<link rel="stylesheet" type="text/css" href="css/W_daohangtiao.css"/>
		<link rel="stylesheet" type="text/css" href="css/middle.css" />
		<script type="text/javascript" src="js/snowfall.jquery.js"></script>
		<script type="text/javascript" src="js/wandajiahua.js"></script>
		...
		<div id="top_div">
			<img src="img/wangda.jpg" id="top_img"/>
		</div>
		<div id="B_form">
			<span id="suoyin"><font color="#AAAAAA"size="4px">网站首页>量身定制>婚礼场地>万达嘉华酒店</font></span>
			<span id="top_title">万达嘉华酒店</span>
			<span id="title_biaoqian">星级酒店</span>
			<span id="address">北京 石景山 石景山路甲18号</span>
			...
			<div id="P_txt">万达嘉华酒店为万达集团旗下自营高端酒店品牌，坐落于石景山区西长安街沿线，毗邻万达生活广场，集休闲娱乐中心等配套设施于一身。 带着“知所需，心安为嘉”的品牌理念，为商务旅行及休闲度假、会议、婚宴宾客，提供品质出众、高效舒适的国际化服务，并予以安心入住的体验，同时也是京城西长安街地标级建筑。 </div>
			<hr id="hr2" color="#E7E7E7" />
			<span id="TeSe">特色亮点</span>
			<table border="0" cellspacing="20" cellpadding="0" id="T_txt">
				<tr>
					<td class="td1">仪式区亮点</td>
					<td class="td2">1400平方米,多个宴会空间灵活多变满足各种规模婚宴  </td>
				</tr>
				<tr>
					<td class="td1">迎宾区亮点</td>
					<td class="td2">五星级装修奢华大堂，时尚的氛围亲切的服务态度  </td>
				</tr>
				<tr>
					<td class="td1">婚宴亮点</td>
					<td class="td2">专属婚宴销售管家式全程管理，轻松实现完美婚礼 </td>
				</tr>
				<tr>
					<td class="td1">特色推荐</td>
					<td class="td2">背靠大型生活综合体石景山万达广场，别致的婚礼宴会体验 </td>
				</tr>
			</table>
			<hr id="hr3" color="#E7E7E7" />
			<span id="DuJia">独家优惠</span>
			<ul id="D_txt">
				<li class="li1">免费试餐服务</li>
				<li class="li2">预定婚宴独享6人婚宴菜品试餐</li>
				<li class="li1">婚房升级礼遇</li>
				<li class="li2">婚礼用房豪华间免费升级至套房</li>
			...
			<img src="img/zhonghua.jpg" id="YHT1_img"/>
			<hr id="hr5" color="#E7E7E7" />
			<span id="YHT2">北京厅 </span>
			...
			<img src="img/beijing.jpg" id="YHT2_img"/>
			...
			<img src="img/qingshuilutai.jpg" id="YHT3_img"/>
			<hr id="hr7" color="#E7E7E7" />
			<span id="YHT4">秦宫、明宫、汉宫、唐宫  </span>
			...
			<img src="img/gong.jpg" id="YHT4_img"/>

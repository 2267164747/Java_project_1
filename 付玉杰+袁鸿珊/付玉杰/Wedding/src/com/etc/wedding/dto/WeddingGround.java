...
private int	   wgprice   ;     
private byte []	   wgpic ;
private byte [] wgbigpic;
private List<BanquetHall> list;
private List<WGDiscount> list2;
private BrandCharacteristics bc;
private DiningStandard ds;
public int getWgid() {
	return wgid;
}
...
public BrandCharacteristics getBc() {
	return bc;
}
public void setBc(BrandCharacteristics bc) {
	this.bc = bc;
}
public DiningStandard getDs() {
	return ds;
}
public void setDs(DiningStandard ds) {
	this.ds = ds;
}
public byte[] getWgbigpic() {
	return wgbigpic;
}
public void setWgbigpic(byte[] wgbigpic) {
	this.wgbigpic = wgbigpic;
}    
}
